...
app.get('/drake', routes.drake);
app.get('/auth/twitter', passport.authenticate('twitter'));
app.get('/auth/twitter/callback',
        passport.authenticate('twitter', { successRedirect: '/drake',
                                           failureRedirect: '/' }));
// app.get('/auth/facebook', passport.authenticate('facebook'));
// app.get('/auth/facebook/callback',
//         passport.authenticate('facebook', { successRedirect: '/drake',
//                                             failureRedirect: '/',
//                                             scope: 'read_stream'
//                                             }));
